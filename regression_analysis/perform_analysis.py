...
def main(shape_, scaleBlendedDir, modelname):
    ...
    # parent_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/train_and_test"
    # output_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/analysis"
    # plot_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/plots/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/stat_test"
    if(shape_==None):
        parent_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/train_and_test"
        output_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/analysis"
        plot_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/plots/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/{plot_subfolder_name}"
    else:
        parent_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/{model}/{category}/{shape}/{angle}/{scaleBlendedDir}/{subset}/{backbone}/{qs_type}/{test_size}/{scale_str}/{model_type}/train_and_test"
        output_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/{model}/{category}/{shape}/{angle}/{scaleBlendedDir}/{subset}/{backbone}/{qs_type}/{test_size}/{scale_str}/{model_type}/analysis"
        plot_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/plots/{model}/{category}/{shape}/{angle}/{scaleBlendedDir}/{subset}/{backbone}/{qs_type}/{test_size}/{scale_str}/{model_type}/{plot_subfolder_name}"
