...
def main(shape_, scaleBlendedDir, modelname, required_shape):
    ...
    # plot_gtVSerror_dir = f"output/plots/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/{plot_subfolder_name}"
    if(shape_==None):
        parent_dir = f"/<dirname>/<name>/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/train_and_test"
        # plot_gtVSerror_dir = f"output/plots/{model}/{shape}/{subset}/{backbone}/{qs_type}/{angle}/{test_size}/{scale_str}/{model_type}/{plot_subfolder_name}"
    else:
        ...
        # plot_gtVSerror_dir = f"output/plots/{model}/{category}/{shape}/{angle}/{scaleBlendedDir}/{subset}/{backbone}/{qs_type}/{test_size}/{scale_str}/{model_type}/{plot_subfolder_name}"
