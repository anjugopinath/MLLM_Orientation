...
#   }
#   config = {
#     'coord': [(0.25, 0.82)],          # one position
#     'area': [0.05],                 # one size
#     'rotation': list(range(360)),  # 0..179 only
#     'bg_resolution': [(500, 500)]  # one resolution
# }
  config = {
      'coord': [(0.5, 0.5)],          # one position
      'area': [0.5],                 # one size
      'rotation': list(range(360)),  # 0..179 only
      'bg_resolution': [(250, 250)]  # one resolution
  }
