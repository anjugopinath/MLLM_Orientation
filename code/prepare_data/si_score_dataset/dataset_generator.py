...
class Dataset:
  ...
  def _generate_and_write_image(self, image_metadata):
    ...
    image_id = self.new_dataset_dir.split('/')[-2] + '_' + str(image_metadata['id'])
    label = self.fg_classes[fg_class]
    # print("self.new_dataset_dir: ", self.new_dataset_dir)
    file_path = '{}/{}/{}.png'.format(self.new_dataset_dir, label, image_id)
