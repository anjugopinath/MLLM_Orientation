...
#     file_sin1 = "/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/LLAVA/llava-v1.5-13b/blended/dog_on_beach/1_degrees/scale1/_visionEncAll/clip_vitl336/what_angle/72_test_samples/Scaled/RidgeRegression/train_and_test"
# file_sin = "/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/LLAVA/blended/dog_on_beach/1_degrees/scale1_3into15_30countbins/_visionEncAll/clip_vitl336/what_angle/72_test_samples/Scaled/RidgeRegression/train_and_test/sin_model_weights.csv"
# file_cos = "/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/LLAVA/blended/dog_on_beach/1_degrees/scale1_3into15_30countbins/_visionEncAll/clip_vitl336/what_angle/72_test_samples/Scaled/RidgeRegression/train_and_test/cos_model_weights.csv"
# out_logs_dir = "/s/red/a/nobackup/vision/anju/g-t_embedding_classifier/utils/logs"
        ...
        for num_bins in step:
            ...
            for scale in origScales:
                ...
                for num in other_nums:
                    ...
                    if(modelname == "llava-v1.5-13b"):
                        #Model weight files
                        # input_modelweights_folder = f"/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/llava-v1.5-13b/{category}/{blended_shape}/{angle_str_plural}/{scale}/_visionEncAll/clip_vitl336/what_angle/72_test_samples/Scaled/RidgeRegression/train_and_test"
                        ...
                        out_emb_dir = f"/s/red/a/nobackup/vision/anju/g-t_embedding_classifier/llava/LLaVA/llava/eval/pca_images/what_angle/{angle_str_singular}/{blended_shape}/{scale}_{pair_str}_{num_bins}random/embeddings"
                        # out_origlogs_dir = f"/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/llava-v1.5-13b/{category}/{blended_shape}/{angle_str_plural}/{scale}/_visionEncAll/clip_vitl336/what_angle/72_test_samples/Scaled/RidgeRegression/train_and_test"
                    elif(modelname == "llava-v1.6-vicuna-13b"):
                        #Model weight files
                        # input_modelweights_folder = f"/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/llava-v1.6-vicuna-13b/{category}/{blended_shape}/{angle_str_plural}/{scale}/_visionEncAll/clip_vitl336/what_angle/72_test_samples/Scaled/RidgeRegression/train_and_test"
                        # input_file_sin = f"{input_modelweights_folder}/sin_model_weights.csv"
                        # input_file_cos = f"{input_modelweights_folder}/cos_model_weights.csv"
                        #Reference embedding file
                        ...
                        #Out dirs for new embeddings
                        out_emb_dir = f"/s/red/a/nobackup/vision/anju/g-t_embedding_classifier/llava1.6/LLaVA/llava/eval/pca_images/what_angle/{angle_str_singular}/{blended_shape}/{scale}_{pair_str}_{num_bins}random/embeddings"
                        # out_logs_dir = "/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/LLAVA/llava-v1.6-vicuna-13b/logs"
                    elif(modelname == "llava-ov-qwen2-7b"):
                        #Reference embedding file
                        ...
                        #Out dirs for new embeddings
                        out_emb_dir = f"/s/red/a/nobackup/vision/anju/g-t_embedding_classifier/llava_next/LLaVA-NeXT/llava/eval/output_embeddings/{category}/{blended_shape}/{scale}_{pair_str}_{num_bins}random"
                    elif(modelname == "Qwen2.5-VL-7B-Instruct"):
                        #Reference embedding file
                        ...
                        #Out dirs for new embeddings
                        out_emb_dir = f"/s/red/a/nobackup/vision/anju/g-t_embedding_classifier/Qwen2.5-VL-7B/github/transformers/src/transformers/models/qwen2_5_vl/output_embeddings/{category}/{blended_shape}/{scale}_{pair_str}_{num_bins}random"
                    ...
                    if(modelname == "llava-v1.5-13b"):
                        ...
                        emb_copy = embedding_copy[str(num)]
                        ...
                        if emb_anchor.ndim == 1:
                            ...
                            emb_copy = emb_copy.reshape(rows, hidden)

                        num_rows, num_cols = emb_anchor.shape  # (648,1280) or (392,1280)

                        for idx in target_indices:
                            row = idx // num_cols
                            col = idx % num_cols

                            emb_copy[row, col] = emb_anchor[row, col]
