...
def main(other_nums, anchor, modelnames, blended_shape, origScales, scaleTitles,
    ...
    for modelname in modelnames:
        if modelname == "llava-v1.5-13b":
            ...
            parent_path = f"/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/llava-v1.5-13b/blended/{blended_shape}/1_degrees_FIXED"
            ...
            parent_path = f"/s/red/a/nobackup/vision/anju/affine_tranformation/objects/DINO/regressor/Linear_Regression/output/llava-v1.6-vicuna-13b/blended/{blended_shape}/1_degrees_FIXED"
        else:
