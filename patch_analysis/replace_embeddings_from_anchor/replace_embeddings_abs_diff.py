            ...
            for scale in origScales:
                ...
                for num in other_nums:
                    ...
                    if modelname == "llava-v1.5-13b":
                        ...
                        out_emb_dir = f"/<dirname>/<name>/g-t_embedding_classifier/llava/LLaVA/llava/eval/pca_images/what_angle/{angle_str_singular}/{blended_shape}/{scale}_{pair_str}_{num_bins}absdiff/embeddings"
                        ...
                        out_emb_dir = f"/<dirname>/<name>/g-t_embedding_classifier/llava1.6/LLaVA/llava/eval/pca_images/what_angle/{angle_str_singular}/{blended_shape}/{scale}_{pair_str}_{num_bins}absdiff/embeddings"
